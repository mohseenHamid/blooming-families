  ...
  return (
    <section className="pt-16 lg:pt-10 pb-16 lg:pb-20 bg-gradient-to-br from-background-white to-primary-green/5 overflow-hidden">
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-stretch mx-auto">
          ...
          <div className="space-y-6" ref={leftRef}>
            ...
            <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center lg:items-start">
              <button
                type="button"
          ...
          <div className="flex justify-center lg:justify-end min-h-0">
            <div className="w-full max-w-md lg:h-full lg:flex min-h-0">
              ...
              <div
                ref={rightCardRef}
                className="bg-white rounded-2xl shadow-xl p-8 w-full border border-gray-100 h-full flex flex-col justify-between overflow-hidden"
                style={{ maxHeight: maxH ? `${maxH}px` : undefined }}
              >
                <div className="shrink-0">
                  {/* Profile Photo + Name/Role */}
                  <div className="text-center mb-6">
                    <div className="w-40 h-40 md:w-48 md:h-48 mx-auto bg-gradient-to-br from-primary-green/20 to-primary-green/40 rounded-full flex items-center justify-center mb-4">
                      <svg className="w-12 h-12 text-primary-green" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>
                      </svg>
                    </div>
                    <h3 className="text-2xl md:text-3xl font-semibold text-primary-navy mb-1">Sarah Johnson</h3>
                    <p className="text-base md:text-lg text-text-grey">Certified Relationship Coach</p>
                  </div>

                  {/* Value-add: Areas of focus pills */}
                  <div className="flex flex-wrap justify-center gap-2 mb-5">
                    <span className="px-3 py-1 rounded-full text-xs font-medium bg-primary-navy/5 text-primary-navy">Conflict resolution</span>
                    <span className="px-3 py-1 rounded-full text-xs font-medium bg-primary-navy/5 text-primary-navy">Parenting support</span>
                    <span className="px-3 py-1 rounded-full text-xs font-medium bg-primary-navy/5 text-primary-navy">Pre-marital prep</span>
                  </div>
                ...
                <div className="pt-5 border-t-2 border-gray-200 shrink-0 mt-auto">
